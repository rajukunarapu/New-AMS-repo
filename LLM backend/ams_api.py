...
class AMSApi:
    ...
    def create_ticket(self, ticket_data):
        ...
        # Strict payload filter to ensure only the 11 fields expected by CreateTicket are sent
        allowed_fields = {
            "clientName", "ams", "typeofticket", "priority", "reportedon",
            "reportedontime", "reportedby", "descriptionofTicket", "screenshort",
            "remarks", "assigntogroup"
        }
